...
describe('The component should render propperly', () => {
    it('Should render with only the required props', () => {
        render(
            <CustomSlider id="test" label="test" min={1} max={10} />
        )
    ...
    it('Should render with all the props', () => {
        render(
            <CustomSlider id="test" label="test" min={1} max={10} initialValue={2} step={1} size='medium' marks disabled color="primary" showTextField />
        )
    ...
    it("Shouldn't render if the min is more or equal to max", () => {
        render(
            <CustomSlider id="test" label="test" min={100} max={10} />
        )
    ...
    it("Shouldn't render if the initial value is more than max, or less than min", () => {
        render(
            <CustomSlider id="test" label="test" min={1} max={10} initialValue={32} />
        )
    ...
    it("Shouldn't render if the step is more than max, or less than min", () => {
        render(
            <CustomSlider id="test" label="test" min={1} max={10} step={32} />
        )
...
describe('The component should update the state as expected', () => {
    it('Should update the state properly', async () => {
        ...
        act(() => render(
            <CustomSlider id="test" label="test" min={1} initialValue={2} max={10} showTextField />
        ))
    ...
    it("Shouldn't accept more than the max, or less than the min", async () => {
        render(
            <CustomSlider id="test" label="test" min={1} max={10} showTextField />
        )
